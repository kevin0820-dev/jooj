...
if (empty($cl["is_logged"])) {
	...
	foreach ($user_data_fields as $field_name => $field_val) {
        if ($field_name == 'uname') {
            ...
            else if(cl_uname_exists($field_val) && $field_val != $se['raw_sname']) {
                $data['err_code'] = "doubling_uname"; break;
            }

            else if(in_array($field_val, $username_restricts) && $field_val != $se['raw_sname']) {
